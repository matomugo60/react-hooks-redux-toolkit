...
// Under the hood, Redux Toolkit uses a library
// called Immer to handle immutable state updates.
// We can safely write code that mutates state,
// as long as we're using createSlice, and Immer will
// ensure that we're not actually mutating state.